...
const Experience = () => {
    return (
        <section className="xl:w-screen xl:h-screen px-10 xl:px-32 pt-80">
			...
			<div className="absolute w-96 h-56 rounded-full filter blur-[50px] xl:top-0 left-1 bg-pink z-0"></div>
            <div className="absolute w-96 h-56 rounded-full filter blur-[100px] top-10 right-72 bg-blue z-0"></div>
		</section>
    )
}
